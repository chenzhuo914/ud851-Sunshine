...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int WEATHER_FORECAST_LOADER_ID = 1202;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // loadWeatherData();
        getSupportLoaderManager().initLoader(WEATHER_FORECAST_LOADER_ID, null, this);
    }
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                try {
                    ...
                    weatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, queryResponse);
                } catch (Exception e) {
                    e.printStackTrace();
                }
