...
public class MainActivity extends AppCompatActivity {
    ...
    private ForecastAdapter mForecastAdaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecastAdaptor = new ForecastAdapter();

        // TODO (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        mRecyclerView.setAdapter(mForecastAdaptor);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                 ...
                 */
                mForecastAdaptor.setWeatherData(weatherData);
            } else {
                showErrorMessage();
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mForecastAdaptor.setWeatherData(null);
            loadWeatherData();
            return true;
        }
