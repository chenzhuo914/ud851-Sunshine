...
//  TODO (18) Create a String array containing the names of the desired data columns from our ContentProvider
    ...
    private static final int ID_DETAIL_LOADER = 1202;
...
//      TODO (31) Display the wind speed and direction
        ...
        float windDegrees = data.getFloat(INDEX_WEATHER_DEGREES);
        String windString = SunshineWeatherUtils.getFormattedWind(this, windSpeed, windDegrees);
